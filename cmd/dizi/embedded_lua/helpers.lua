...
function help()
    ...
    print("")
    print("Library Usage:")
    print("  json = require('json')    - Load JSON library")
    print("  yaml = require('yaml')    - Load YAML library")
    print("  time = require('time')    - Load Time library")
    print("  strings = require('strings') - Load Strings library")
    print("  Note: Use global variables, not 'local' in REPL")
    print("")
    print("Examples:")
    print("  2 + 3             - Simple expression")
    print("  x = 10; x * 2     - Variables")
    print("  print('hello')    - Output")
    print("  json = require('json'); json.encode({a=1}) - JSON encode")
